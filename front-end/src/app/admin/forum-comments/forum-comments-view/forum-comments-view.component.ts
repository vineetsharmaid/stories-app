...
@Component({
  selector: 'app-forum-comments-view',
  templateUrl: './forum-comments-view.component.html',
  styleUrls: ['./forum-comments-view.component.css']
})
export class ForumCommentsViewComponent implements OnInit {
