...
@Component({
  selector: 'app-answers-flagged',
  templateUrl: './answers-flagged.component.html',
  styleUrls: ['./answers-flagged.component.scss']
})
export class AnswersFlaggedComponent implements OnInit {
	...
	public answers: Array<Object>;
  	...
  	ngOnInit() {
  		...
  		this.getFlaggedanswers();
  	}

  	getFlaggedanswers() {
	   	
	   	// 0: value for status pending
	    this.forumService.getFlaggedanswers().subscribe((response: Array<Object>) => {
