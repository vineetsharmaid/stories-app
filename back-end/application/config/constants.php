...
define('TAG_STATUS_DRAFT',0);
define('TAG_STATUS_PUBLISHED',1);

define('COMMENT_STATUS_DRAFT',0);
define('COMMENT_STATUS_PUBLISHED',1);

define('POINTS_FOR_10_LIKES',10);
define('POINTS_FOR_20_LIKES',20);
define('POINTS_FOR_30_LIKES',50);

define('POINTS_FOR_10_SHARES',10);
define('POINTS_FOR_20_SHARES',20);
define('POINTS_FOR_30_SHARES',50);

define('POINTS_FOR_10_COMMENTS',10);
...
define('APP_URL','https://storiesofasia.co/');
