...
class User_model extends CI_Model {
    ...
    public function get_user_story_details($story_id) {
        ...
        $this->db->select('stories.title, stories.preview_title, stories.preview_subtitle, stories.created, stories.story_id, stories.slug, stories.author_id, stories.featured, users.first_name, users.last_name, users.username, count(distinct story_user_shares.share_id) as total_shares, count(distinct story_user_views.user_id) as total_views, count(distinct story_user_likes.user_id) as total_likes, count(distinct comments.comment_id) as total_comments');
