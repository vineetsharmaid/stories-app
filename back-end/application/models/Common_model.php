...
class Common_model extends CI_Model {
    ...
    public function get_users()
    {
        ...
        $this->db->select('users.user_id, users.first_name, users.last_name, users.profile_pic, users.user_email, users.user_type, users.username, users.company_id, users.created, users.status as status_id, status.name as status');
        $this->db->from('users');
    ...
    public function get_question_data($where, $user_id="")
    {
      ...
      if ( $user_id=="" ) {
        ...
        $this->db->select('forum_questions.*, users.first_name, users.last_name, users.username, users.profile_pic, 
